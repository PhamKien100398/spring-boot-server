...
import com.trungkien.backend.dto.*;
import com.trungkien.backend.entity.*;
import com.trungkien.backend.service.*;
...
//            Convert answer sheet to json
    ...
    public ResponseEntity<?> createExam(@Valid @RequestBody Exam exam, @RequestParam Long intakeId, @RequestParam Long partId, boolean locked) {
        try {
            String username = userService.getUserName();
            User user = userService.getUserByUsername(username).get();
...
//            }
    ...
    public ResponseEntity<Boolean> cancelExam(@PathVariable Long id) {
        String username = userService.getUserName();
        User user = userService.getUserByUsername(username).get();
        Date now = new Date();
